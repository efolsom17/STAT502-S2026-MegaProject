...
mcmc_plot(uniform_gamma_14_100$nu_5, variable = "nu", type = "trace") +
    labs(
        title = expression(paste("Traceplot of MCMC Chains for ", nu, " = 5")),
        subtitle = "Uniform(1, 50) Prior | Sample Size 100"
    )
mcmc_plot(uniform_gamma_14_100$nu_6, variable = "nu", type = "trace") +
    labs(
        title = expression(paste("Traceplot of MCMC Chains for ", nu, " = 6")),
        subtitle = "Uniform(1, 50) Prior | Sample Size 100"
    )
mcmc_plot(uniform_gamma_14_100$nu_7, variable = "nu", type = "trace") +
    labs(
        title = expression(paste("Traceplot of MCMC Chains for ", nu, " = 7")),
        subtitle = "Uniform(1, 50) Prior | Sample Size 100"
    )
mcmc_plot(uniform_gamma_14_100$nu_15, variable = "nu", type = "trace") +
    labs(
        title = expression(paste("Traceplot of MCMC Chains for ", nu, " = 15")),
        subtitle = "Uniform(1, 50) Prior | Sample Size 100"
    )
mcmc_plot(uniform_gamma_14_100$nu_17, variable = "nu", type = "trace") +
    labs(
        title = expression(paste("Traceplot of MCMC Chains for ", nu, " = 17")),
        subtitle = "Uniform(1, 50) Prior | Sample Size 100"
    )
mcmc_plot(uniform_gamma_14_100$nu_20, variable = "nu", type = "trace") +
    labs(
        title = expression(paste("Traceplot of MCMC Chains for ", nu, " = 20")),
        subtitle = "Uniform(1, 50) Prior | Sample Size 100"
    )
...
mcmc_plot(uniform_gamma_14_1000$nu_5, variable = "nu", type = "trace") +
    labs(
        title = expression(paste("Traceplot of MCMC Chains for ", nu, " = 5")),
        subtitle = "Uniform(1, 50) Prior | Sample Size 1000"
    )
mcmc_plot(uniform_gamma_14_1000$nu_6, variable = "nu", type = "trace") +
    labs(
        title = expression(paste("Traceplot of MCMC Chains for ", nu, " = 6")),
        subtitle = "Uniform(1, 50) Prior | Sample Size 100"
    )
mcmc_plot(uniform_gamma_14_1000$nu_7, variable = "nu", type = "trace") +
    labs(
        title = expression(paste("Traceplot of MCMC Chains for ", nu, " = 7")),
        subtitle = "Uniform(1, 50) Prior | Sample Size 1000"
    )
mcmc_plot(uniform_gamma_14_1000$nu_15, variable = "nu", type = "trace") +
    labs(
        title = expression(paste("Traceplot of MCMC Chains for ", nu, " = 15")),
        subtitle = "Uniform(1, 50) Prior | Sample Size 1000"
    )
mcmc_plot(uniform_gamma_14_1000$nu_17, variable = "nu", type = "trace") +
    labs(
        title = expression(paste("Traceplot of MCMC Chains for ", nu, " = 17")),
        subtitle = "Uniform(1, 50) Prior | Sample Size 1000"
    )
mcmc_plot(uniform_gamma_14_1000$nu_20, variable = "nu", type = "trace") +
    labs(
        title = expression(paste("Traceplot of MCMC Chains for ", nu, " = 20")),
        subtitle = "Uniform(1, 50) Prior | Sample Size 1000"
    )
